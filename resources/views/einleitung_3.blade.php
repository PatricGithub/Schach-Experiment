          ...
          <div class="container">
            <div class="wrap">
                <div class="fix-8-12 left magazine2">
                   ...
                   <p class="micro">Deine Aufgabe ist es, dir zu jeder vorgegebenen Partie eine analoge Situation auf dem leeren Schachbrett auszudenken.  Suche nach einer Partie, in der eine ähnliche Anordnung der Figuren entstanden ist. Vielleicht stand der König ähnlich unter Druck, oder es gab eine ähnliche Bauernstruktur. Du kannst dafür alle Figuren oberhalb und unterhalb des leeren Bretts benutzen. Die Analogie muss nicht dieselben Figuren verwenden, aber die Strukturen sollten sich ähneln.</p> 
                   <p class="micro">Nachdem du deine analoge Position aufgebaut hast, erläutere bitte deine Beweggründe
                    <br>- Warum hast du genau diese Position gewählt?
                    <br>- Woher stammt deine Inspiration? (War es eine Partie, die du selbst gespielt hast, beobachtet hast, oder hast du sie für diese Aufgabe erfunden?)</p> 
                   <p class="micro">Zum Schluss sollst du deine Faszination für die selbst erstellte Brettzusammenstellung bewerten.</p> 
                   <p class="micro">Erinnere dich an das Beispiel mit Hänsel und Gretel. Weder Hänsel und Gretel noch ihr Lebkuchenhaus haben etwas mit dem Klimawandel zu tun.  Aber die Art und Weise, wie sie ihr Zuhause zerstören, ähnelt der Art und Weise, wie wir unseren Planeten zerstören, indem wir Ressourcen ohne Rücksicht auf die Folgen verbrauchen.  Genau diese Art der Ähnlichkeit solltest du beim Befüllen des leeren Bretts berücksichtigen.</p>
                   <p class="micro"><strong>Wichtig:</strong> Wenn dir zu einer vorgegebenen Partie keine konkrete Analogie einfällt, kannst du gerne eine neue Situation erfinden! Achte aber darauf, dass die erstellten Positionen grundsätzlich spielbar sind.</p>                  
