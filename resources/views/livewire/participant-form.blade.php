<div>
    ...
    <form wire:submit.prevent="saveParticipant" class="fix-6-12 left">
        <div>
            <label for="ranking" class="label">Wie hoch ist dein Ranking/ELO? (Falls nicht vorhanden bitte 600 angeben)</label>
            <input type="text" id="ranking" wire:model.defer="ranking" class="input" required>
        </div>
<br>
        <div>
            <label for="age" class="label">Wie alt bist du?</label>
            <input type="number" id="age" wire:model.defer="age" class="input" required>
        </div>
<br>
        <div>
            <label for="ageStarted" class="label">Mit wie viel Jahren hast du angefangen Schach zu lernen/spielen?</label>
...
<br>
        <div>
            <label for="frequencyPlaying" class="label">Wie oft hast du im letzten Jahr pro Woche Schach gespielt, oder dich mit Schach beschäftigt (Training, Analyse eigener/fremder Partien etc.)?</label>
